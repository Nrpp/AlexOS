"""Real, persisted class schedule - className + day + startTime +
location. Same generic module-data pattern as modules/shopping_list
(duplicated, not shared - modules are independently loaded)."""
...
async def create_item(
    storage: StorageManager, class_name: str, day: str, start_time: str, location: str
) -> dict[str, Any]:
